    ...
    <div className="flex min-h-0 flex-1 items-center justify-center bg-background">
        <div className="w-[500px]">
            <div className="bg-white shadow-[0_0_20px_rgba(0,0,0,0.2),0_5px_5px_rgba(0,0,0,0.24)] p-[45px] text-center mt-6">
                ...
                <p className="text-sm text-black text-left">Name:</p>
                <input
                   type="text"
                   ...
                   onBlur={saveName}
                   className="w-full bg-gray-50 rounded-lg p-3 text-sm text-gray-500 text-left"
               />
                
                <p className="text-sm text-black text-left mt-2">Email:</p>
                ...
                className="mt-6 text-red-600 text-sm hover:text-red-800"
                >
                Delete Account
                </button>
